	...
	$pessoa = new Pessoa(); $kits = new Kits();
	$evento = new Evento();
	...
	?>
	<h2>Kit está entregue a <?php echo $pessoa->get_nome(); ?>?</h2>
		
	<h2><a href="kits/action/entrega_action.php?cp=<?php echo $pessoa->get_codigo_pessoa(); ?>">Sim, kit está entregue.</a></h2>
	...
	<h2>Kit está entregue a <?php echo $kits->get_nome(); ?>?</h2>
		
	<h2><a href="kits/action/entrega_action.php?em=<?php echo $kits->get_email(); ?>">Sim, kit está entregue.</a></h2>
