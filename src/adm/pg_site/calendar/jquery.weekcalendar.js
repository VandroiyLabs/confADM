...
(function($) {
   ...
   $.widget("ui.weekCalendar", {
      ...
      _refreshEventDetails : function(calEvent, $calEvent) {
         var self = this;
         var options = this.options;
         $calEvent.find(".wc-time").html(calEvent.titulo);
         $calEvent.find(".wc-title").html(calEvent.chamada);
         
         $calEvent.find(".wc-autor").html(calEvent.autor+" ("+calEvent.instituicao+")");
