<?php
		...
		if ($contador_pagina > 1)		{ $lk_anterior="?page=atribuicao_resumo&pagina_atual=".$anterior; }
		else							{ $lk_anterior="#"; };
		
		if ($contador_pagina < $total_pagina)		{ $lk_proximo="?page=atribuicao_resumo&pagina_atual=".$proximo; }
		else										{ $lk_proximo="#"; };
		...
		echo "<input type='hidden' name='nome' value='".$_POST["nome"]."' />
			...
			<input type='hidden' name='avaliacao' value='".$_POST['avaliacao']."' />
			<input type='hidden' name='avaliacao_check_0' value='".$_POST['avaliacao_check_0']."' />
			<input type='hidden' name='avaliacao_check_1' value='".$_POST['avaliacao_check_1']."' />
			<input type='hidden' name='avaliacao_check_2' value='".$_POST['avaliacao_check_2']."' />";
		...
		{
			$link = "?page=atribuicao_resumo&pagina_atual=$lk_total";
