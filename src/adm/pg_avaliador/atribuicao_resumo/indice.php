<?php
		...
		for ( $lk_total = 1; $lk_total<=$total_pagina; $lk_total++ )
		{
			...
			{
			  echo "<a href=\"?page=atribuicao_resumo&pagina_atual=$lk_total\"><font color='red'><b>$lk_total</b></font></a>&nbsp&nbsp";
			}
			else
			{
			  echo "<a href=\"?page=atribuicao_resumo&pagina_atual=$lk_total\"><b>$lk_total</b></a>&nbsp&nbsp";
			}
