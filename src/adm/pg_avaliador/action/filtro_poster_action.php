...
<?php
	...
	if(isset($_POST['avaliador']) and $_POST['avaliador'] == '1')
	{
		...
		$virgula = "";
			...
			{
				$check0= "(Avalia_Poster.codigo_avaliador1 > 0 and Avalia_Poster.codigo_avaliador2 > 0) ";
				$or=" or ";
			}
			
			if ( isset($_POST['avaliador_check_1']) and strcmp($_POST['avaliador_check_1'], '1') == 0 )
			{
				$check1= $or."((Avalia_Poster.codigo_avaliador1 = 0 and Avalia_Poster.codigo_avaliador2 > 0) or (Avalia_Poster.codigo_avaliador1 > 0 and Avalia_Poster.codigo_avaliador2 = 0)) ";
				$or=" or ";
			}

			if ( isset($_POST['avaliador_check_2']) and strcmp($_POST['avaliador_check_2'], '2') == 0 )
			{
				$check2= $or."(Avalia_Poster.codigo_avaliador1 = 0 and Avalia_Poster.codigo_avaliador2 = 0) ";
				$or=" or ";
			}
