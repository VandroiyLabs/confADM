<?php
		...
		for ( $lk_total = 1; $lk_total<=$total_pagina; $lk_total++ )
		{
			...
			{
			  echo "<a href=\"?p1=pesquisar&pagina_atual=$lk_total&nome=".$_POST["nome"]."\"><font color='red'><b>$lk_total</b></font></a>&nbsp&nbsp";
			}
			else
			{
			  echo "<a href=\"?p1=pesquisar&pagina_atual=$lk_total&nome=".$_POST["nome"]."\"><b>$lk_total</b></a>&nbsp&nbsp";
			}
